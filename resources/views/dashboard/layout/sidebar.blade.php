    ...
    <div class="sidebar-content js-simplebar">
      ...
      c0.2,0.5,0,1.1-0.5,1.3l-9,4C10.3,20,10.1,20,10,20z" />
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.cars.*') ? 'active' : '' }}">
                <a data-bs-target="#pages" data-bs-toggle="collapse" class="sidebar-link collapsed">
                    <i class="align-middle me-2 fas fa-fw fa-car"></i>
                    <span class="align-middle">Mobil</span>
                </a>
                <ul id="pages" class="sidebar-dropdown list-unstyled collapse {{ request()->routeIs('admin.cars.*') ? 'show' : '' }}" data-bs-parent="#sidebar">
                    <li class="sidebar-item {{ request()->routeIs('admin.cars.create') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('admin.cars.create') }}">Tambah Mobil</a>
                    </li>
                    <li class="sidebar-item {{ request()->routeIs('admin.cars.index') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('admin.cars.index') }}">List Mobil</a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-item {{ request()->routeIs('admin.drivers.*') ? 'active' : '' }}">
                ...
                <ul id="pages-drivers" class="sidebar-dropdown list-unstyled collapse {{ request()->routeIs('admin.drivers.*') ? 'show' : '' }}" data-bs-parent="#sidebar">
                    <li class="sidebar-item {{ request()->routeIs('admin.drivers.create') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('admin.drivers.create') }}">Tambah Sopir</a>
                    </li>
                    <li class="sidebar-item {{ request()->routeIs('admin.drivers.index') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('admin.drivers.index') }}">List Sopir</a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-item {{ request()->routeIs('admin.rentcars.*') ? 'active' : '' }}">
                ...
                <ul id="pages-penyetuju" class="sidebar-dropdown list-unstyled collapse {{ request()->routeIs('admin.rentcars.*') ? 'show' : '' }}" data-bs-parent="#sidebar">
                    <li class="sidebar-item {{ request()->routeIs('admin.rentcars.create') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('admin.rentcars.create') }}">Tambah Penyetuju</a>
                    </li>
                    <li class="sidebar-item {{ request()->routeIs('admin.rentcars.index') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('admin.rentcars.index') }}">List Penyetuju</a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-item {{ request()->routeIs('admin.pemesanans.*') ? 'active' : '' }}">
                ...
                <ul id="pages-pemesanan" class="sidebar-dropdown list-unstyled collapse {{ request()->routeIs('admin.pemesanans.*') ? 'show' : '' }}" data-bs-parent="#sidebar">
                    <li class="sidebar-item {{ request()->routeIs('admin.pemesanans.create') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('admin.pemesanans.create') }}">Tambah Pemesanan</a>
                    </li>
                    <li class="sidebar-item {{ request()->routeIs('admin.pemesanans.index') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('admin.pemesanans.index') }}">List Pemesanan</a>
                    </li>
                </ul>
            </li>
