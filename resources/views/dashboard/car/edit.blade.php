                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Edit Mobil</h5>
                        </div>
                        <div class="card-body">
                            <form
                                id="form"
                            ...
                            >
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" min="2" class="form-control" name="chairs_ammount" value="{{ $car->chairs_ammount }}" placeholder="6">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">No Polisi</label>
                                        <input type="text" class="form-control" name="vehicle_license" value="{{ $car->vehicle_license }}" placeholder="N 1543 RE">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label class="form-label">Merk</label>
                                        <input type="text" class="form-control" name="merk" value="{{ $car->merk }}" placeholder="Honda">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Harga / hari</label>
                                        <input type="number" min="0" class="form-control" name="price" value="{{ $car->price }}" placeholder="250000">
                                    </div>
                                </div>
                                <div class="row mb-5">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="car_type">
                                            <option {{ ($car->car_type == 'city car') ? 'selected' : '' }} value="city car">City Car</option>
                                            <option {{ ($car->car_type == 'compact mpv') ? 'selected' : '' }} value="compact mpv">Compact MPV</option>
                                            <option {{ ($car->car_type == 'mini mpv') ? 'selected' : '' }} value="mini mpv">Mini MPV</option>
                                            <option {{ ($car->car_type == 'minivan') ? 'selected' : '' }} value="minivan">Minivan</option>
                                            <option {{ ($car->car_type == 'city car') ? 'selected' : '' }} value="suv">SUV</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
